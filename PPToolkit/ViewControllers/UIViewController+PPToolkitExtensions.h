//
//  UIViewController+PPToolkitExtensions.h
//  PPToolkit
//
...
// Lifecycle phases
typedef enum {
    PPViewControllerLifeCyclePhaseEnumBegin = 0,
    PPViewControllerLifeCyclePhaseInitialized = PPViewControllerLifeCyclePhaseEnumBegin,
    PPViewControllerLifeCyclePhaseViewDidLoad,
    PPViewControllerLifeCyclePhaseViewWillAppear,
    PPViewControllerLifeCyclePhaseViewDidAppear,
    PPViewControllerLifeCyclePhaseViewWillDisappear,
    PPViewControllerLifeCyclePhaseViewDidDisappear,
    PPViewControllerLifeCyclePhaseViewWillUnload,
    PPViewControllerLifeCyclePhaseViewDidUnload,
    PPViewControllerLifeCyclePhaseEnumEnd,
    PPViewControllerLifeCyclePhaseEnumSize = PPViewControllerLifeCyclePhaseEnumEnd - PPViewControllerLifeCyclePhaseEnumBegin
} PPViewControllerLifeCyclePhase;
 ...
 * starting with iOS 5).
 */
@interface UIViewController (PPToolkitExtensions)
