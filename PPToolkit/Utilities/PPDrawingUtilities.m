...
void PPDrawRoundedRect(CGContextRef context, CGRect rect, CGFloat cornerRadius) {
...
CGGradientRef PPCreateGradientWithColors(NSArray *colors) {
	return PPCreateGradientWithColorsAndLocations(colors, nil);
}


CGGradientRef PPCreateGradientWithColorsAndLocations(NSArray *colors, NSArray *locations) {
...
void PPDrawGradientInRect(CGContextRef context, CGGradientRef gradient, CGRect rect) {
