...
#ifndef PPDRAWINGUTILITIES
#define PPDRAWINGUTILITIES
...
extern void PPDrawRoundedRect(CGContextRef context, CGRect rect, CGFloat cornerRadius);
...
extern CGGradientRef PPCreateGradientWithColors(NSArray *colors);
extern CGGradientRef PPCreateGradientWithColorsAndLocations(NSArray *colors, NSArray *locations);
...
extern void PPDrawGradientInRect(CGContextRef context, CGGradientRef gradient, CGRect rect);